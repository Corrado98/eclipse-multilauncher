...
public abstract class AbstractLaunchStrategy {
	 ...
	 */
	public final void launchAndWait(ILaunchConfiguration launchConfiguration, String mode, String param) {
		try {
			ILaunch launch = launchConfiguration.launch(mode, null);
			waitForLaunch(launch, param);
	 ...
	 * @param param the runtime parameter for this strategy (e.g. delay time)
	 */
	protected abstract void waitForLaunch(ILaunch launch, String param);
